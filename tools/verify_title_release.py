"""Non-mutating local/public release checks for site12 title changes."""
...
# Initial Git worktree was clean; no initial untracked content to migrate.
PRIVATE_FILES = {}
...
def fetch(url):
    request=Request(url,headers={"User-Agent":"Site12-Title-Release-Check/1.0"})
